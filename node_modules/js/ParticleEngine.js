...
class ParticleEngine
{
	...
	constructor() {
		...
		this.particleGeometry.setAttribute('position', new BufferAttribute(new Vector3(), 3));
...
ParticleEngine.prototype.initialize = function(scene)
{
     ...
     */
     /*****************************FINISH COMMENTED CODE**************/
		...
		this.particleGeometry.setAttribute('position'+ i,new BufferAttribute(this.particleArray[i].position,3));
	
		this.particleGeometry.setAttribute('position'+i, new BufferAttribute(this.customVisible.value[i], 3));
...
ParticleEngine.prototype.update = function(dt)
{
	...
	for (var j = 0; j < recycleIndices.length; j++)
	{
		...
		this.particleGeometry.defaultAttributeValues.position.array[i] =this.particleArray[i].position;
	}
